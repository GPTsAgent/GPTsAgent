...
| Apps/connectors | Off for public pilot; optional only for scoped workspace deployments |
...
- Apps/connectors and Actions must not be enabled together; Apps also block the public GPT Store path in current docs.
