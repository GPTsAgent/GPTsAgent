...
COMMUNITY_FILES = [
    ...
    Path("scripts/prepublish_audit.py"),
...
def main() -> int:
    ...
    checks = [
        ...
        check("prepublish_audit.py" in root_readme_text and "private-marker scans" in root_readme_text, "root README documents prepublish audit coverage"),
