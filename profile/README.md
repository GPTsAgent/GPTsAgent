...
**Sandbox File Operator** is the flagship configuration pack. Current package version: `v0.2.0`.
...
GPTsAgent is in early public pilot packaging around the Sandbox File Operator v0.2 configuration. The next milestone is a recorded GPT Builder Preview run using the pilot launch checklist.
